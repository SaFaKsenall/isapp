                      ...
                      try {
                        ...
                        if (user.email != null) {
                          ...
                          try {
                            ...
                            print(
                                'E-posta gönderildi: ${sendReport.toString()}');
                        ...
                        if (selectedTemplate == 'activateaccount') {
                          // Önce aktivasyon kodunu oluştur
                          final activationCode = _generateActivationCode();

                          // E-posta şablonundaki kodu güncelle
                          final updatedEmailContent = emailTemplates[
                                  'activateaccount']!
                              .replaceAll('CODE_PLACEHOLDER', activationCode)
                              .replaceAll(
                                  'navigator.clipboard.writeText(document.getElementById(\'activation-code\').textContent)',
